...
import * as Plugin_0 from '/Users/zhufeng/Desktop/wh/apps/web/src/app.tsx';
  ...
  return [
    {
      ...
      path: process.env.NODE_ENV === 'production' ? void 0 : '/Users/zhufeng/Desktop/wh/apps/web/src/app.tsx',
    },
    {
      apply: Plugin_1,
